...
- `references/daily_notify.py` — 每日标讯推送（v4.0.0，完整版：27关键词+PDF解析+分片推送）
...
### 3. extract_candidates正则不匹配（2026-04-25 修复）
**问题**：原正则没有匹配到"标包N第一名 公司名"格式，导致12条候选人中多条显示"-"
...
**排除词:** 视频监控、防雷检测、电力监控、碳减排、安全生产、碳中和、交通安全、道路交通
